    ...
    class s {
        constructor(e, t) {
            const i =
                ...
                l = function (e, t, i) {
                    console.warn(
                        `Bootstrap Toggle deprecation warning: Using ${t} ${e} is deprected. Use ${i} instead.`
                    );
                },
                o = "On",
                a = "primary",
            ...
            (t = t || {}),
                ...
                (this.options = {
                    ...
                    style:
                        this.element.getAttribute("data-style") || t.style || u,
                    width:
                        this.element.getAttribute("data-width") || t.width || f,
                    height:
                ...
                this.options.offlabel === i &&
                    (this.element.getAttribute("data-off")
                        ? (l(s, "data-off", "data-offlabel"),
                          (this.options.offlabel =
                              this.element.getAttribute("data-off")))
                        : t.off
                        ? (l(n, "off", "offlabel"),
                          (this.options.offlabel = t.off))
        ...
        render() {
            ...
            var i = document.createElement("span"),
                s =
                    (i.setAttribute(
                        "class",
                        "btn btn-" + this.options.onstyle + " " + t
                    ),
                    (i.innerHTML = this.options.onlabel),
                    this.options.ontitle &&
                        i.setAttribute("title", this.options.ontitle),
                    document.createElement("span")),
                n =
                    (s.setAttribute(
                        "class",
                        "btn btn-" + this.options.offstyle + " " + t
                    ),
                    (s.innerHTML = this.options.offlabel),
                    this.options.offtitle &&
                        s.setAttribute("title", this.options.offtitle),
                    document.createElement("span")),
                l =
                    (n.setAttribute("class", "toggle-handle btn " + t),
                    document.createElement("div"));
            l.setAttribute("class", "toggle-group"),
                l.appendChild(i),
                l.appendChild(s),
                l.appendChild(n);
            let o = document.createElement("div"),
                a =
                    ...
                    (this.element.disabled || this.element.readOnly) &&
            ...
            this.options.offvalue &&
                ((a = this.element.cloneNode()).setAttribute(
                    "value",
                    this.options.offvalue
                ),
                ...
                this.options.height &&
                    ((i.style.lineHeight = e(i) + "px"),
                    (s.style.lineHeight = e(s) + "px")),
        ...
        update(e) {
            this.element.disabled
                ...
                ? this.readonly()
                : this.enable(),
                this.element.checked ? this.on(e) : this.off(e);
        }
        trigger(e) {
            e ||
        ...
        destroy() {
            this.ecmasToggle.parentNode.insertBefore(
                this.element,
                this.ecmasToggle
            ),
